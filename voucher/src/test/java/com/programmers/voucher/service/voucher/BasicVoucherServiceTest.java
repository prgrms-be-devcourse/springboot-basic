...
class BasicVoucherServiceTest {
    ...
    void createVoucher() {
        ...
        DiscountPolicy.Type voucherFixedType = DiscountPolicy.Type.FIXED;
        ...
        DiscountPolicy.Type voucherPercentageType = DiscountPolicy.Type.PERCENTAGE;
    ...
    void constraintCreate() {
        ...
        final DiscountPolicy discountPolicyFixed = new DiscountPolicy(0, DiscountPolicy.Type.FIXED);
        ...
        final Voucher voucherFixed = voucherService.create(fixedVoucherName, DiscountPolicy.Type.FIXED, -2500, 1);

        verify(voucherRepository).save(new Voucher(fixedVoucherName, discountPolicyFixed, 1));
        assertEquals(DiscountPolicy.Type.FIXED, voucherFixed.getDiscountPolicy().getType());
        assertEquals(0, voucherFixed.getDiscountPolicy().getAmount());

        String percentageVoucherName = "PercentageVoucherName";
        final DiscountPolicy discountPolicyPercentage1 = new DiscountPolicy(100, DiscountPolicy.Type.PERCENTAGE);
        ...
        final Voucher voucherPercentage1 = voucherService.create(percentageVoucherName, DiscountPolicy.Type.PERCENTAGE, 250, 2);

        verify(voucherRepository).save(new Voucher(percentageVoucherName, discountPolicyPercentage1, 2));
        assertEquals(DiscountPolicy.Type.PERCENTAGE, voucherPercentage1.getDiscountPolicy().getType());
        assertEquals(100, voucherPercentage1.getDiscountPolicy().getAmount());

        final DiscountPolicy discountPolicyPercentage2 = new DiscountPolicy(0, DiscountPolicy.Type.PERCENTAGE);
        ...
        final Voucher voucherPercentage2 = voucherService.create(percentageVoucherName, DiscountPolicy.Type.PERCENTAGE, -250, 2);

        verify(voucherRepository).save(new Voucher(percentageVoucherName, discountPolicyPercentage2, 2));
        assertEquals(DiscountPolicy.Type.PERCENTAGE, voucherPercentage2.getDiscountPolicy().getType());
    ...
    void updateVoucher() {
        Voucher beforeNameUpdate = new Voucher(1, "updateMe", new DiscountPolicy(2500, DiscountPolicy.Type.FIXED), LocalDate.now(), 1111);
        Voucher afterNameUpdate = new Voucher(1, "updated", new DiscountPolicy(2500, DiscountPolicy.Type.FIXED), LocalDate.now(), 1111);
        ...
        Voucher beforeTypeUpdate = new Voucher(2, "typeUpdateVoucher", new DiscountPolicy(2500, DiscountPolicy.Type.FIXED), LocalDate.now(), 2222);
        Voucher afterTypeUpdate = new Voucher(2, "typeUpdateVoucher", new DiscountPolicy(100, DiscountPolicy.Type.PERCENTAGE), LocalDate.now(), 2222);
        ...
        Voucher beforeAmountUpdate = new Voucher(3, "amountUpdateVoucher", new DiscountPolicy(500, DiscountPolicy.Type.FIXED), LocalDate.now(), 3333);
        Voucher afterAmountUpdate = new Voucher(3, "amountUpdateVoucher", new DiscountPolicy(5000, DiscountPolicy.Type.FIXED), LocalDate.now(), 3333);
    ...
    void constraintsUpdate() {
        Voucher fixedBefore = new Voucher(1, "typeUpdateVoucher", new DiscountPolicy(-2500, DiscountPolicy.Type.FIXED), LocalDate.now(), 2222);
        Voucher fixedAfter = new Voucher(1, "typeUpdateVoucher", new DiscountPolicy(0, DiscountPolicy.Type.FIXED), LocalDate.now(), 2222);
        ...
        Voucher percentageBefore1 = new Voucher(2, "typeUpdateVoucher", new DiscountPolicy(-250, DiscountPolicy.Type.PERCENTAGE), LocalDate.now(), 3333);
        Voucher percentageAfter1 = new Voucher(2, "typeUpdateVoucher", new DiscountPolicy(0, DiscountPolicy.Type.PERCENTAGE), LocalDate.now(), 3333);
        ...
        Voucher percentageBefore2 = new Voucher(3, "typeUpdateVoucher", new DiscountPolicy(250, DiscountPolicy.Type.PERCENTAGE), LocalDate.now(), 4444);
        Voucher percentageAfter2 = new Voucher(3, "typeUpdateVoucher", new DiscountPolicy(100, DiscountPolicy.Type.PERCENTAGE), LocalDate.now(), 4444);
    ...
    void listAllVouchers() {
        ...
        for(int i=0;i<10;i++) {
            Voucher compare = new Voucher(i + 1, "voucherName" + i, new DiscountPolicy(2500, DiscountPolicy.Type.FIXED), LocalDate.now(), 1000 + i);
    ...
    void discount() {
        Voucher fixedVoucher = new Voucher("voucher", new DiscountPolicy(2500, DiscountPolicy.Type.FIXED), 1234);
        assertEquals(7500, fixedVoucher.discount(10000));

        Voucher percentageVoucher = new Voucher("voucher", new DiscountPolicy(25, DiscountPolicy.Type.PERCENTAGE), 5678);
