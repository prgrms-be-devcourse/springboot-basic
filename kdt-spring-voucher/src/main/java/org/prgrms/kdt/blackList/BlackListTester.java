...
public class BlackListTester {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var CsvFileName = "customer_blacklist.csv";
        ...
        fileIOStream.inputCsvFile(black1,CsvFileName);
        fileIOStream.inputCsvFile(black2,CsvFileName);
        fileIOStream.inputCsvFile(black3,CsvFileName);
