...
- 참고: [https://dzone.com/articles/interactive-용console-applications-in-java](https://dzone.com/articles/interactive-console-applications-in-java)
- 스프링부트 애플리케이션으로 만든다.
    - Web기능이 없이만듭니다. 즉, 서버가 띄지 않고 커맨드라인 애플리케이션으로 동작해야한다.
...
- [ ]  create / list 커맨드를 지원한다.
    ...
    - 바우처 정보를 매모리에 관리한다. 어플리케이션이 종료가 되용어 데이터가 모두 사라져도 괜찮습니다. (나중에 영속성을 가지도록 변경할거에요 걱정마세요!)
