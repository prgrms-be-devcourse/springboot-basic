...
public class VoucherService {
    ...
    public Voucher addVoucher(InsertVoucherDto insertVoucherDto) {
        Voucher voucher = VoucherType.getVoucherType(
            insertVoucherDto.getVoucherType(),
            insertVoucherDto.getVoucherId(),
            insertVoucherDto.getDiscount(),
            insertVoucherDto.getCreatedAt());
        return voucherRepository.insert(voucher);
    }

    public Voucher modifyVoucher(UpdateVoucherDto voucherDto) {
        Voucher voucher = getVoucher(voucherDto.getVoucherId());
        Voucher updateVoucher = VoucherType.getVoucherType(
