...
class OrderServiceTest {
    ...
    public void createOrderByStub() throws Exception {
        ...
        FixedAmountVoucher voucher = new FixedAmountVoucher(UUID.randomUUID(), 100, LocalDateTime.now());
    ...
    public void createOrderByMock() throws Exception {
        ...
        when(voucherService.findById(fixedAmountVoucher.getVoucherId())).thenReturn(fixedAmountVoucher);
        ...
        inOrder.verify(voucherService).findById(fixedAmountVoucher.getVoucherId());
