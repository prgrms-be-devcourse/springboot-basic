...
class JdbcVoucherWalletRepositoryTest {
    ...
    private JdbcVoucherWalletRepository customerVoucherWalletRepository;
    ...
    @BeforeEach
    void setUp() {
        customerVoucherWalletRepository = new JdbcVoucherWalletRepository(dataSource);
    ...
    void deleteByCustomerVoucherWallet_SavedWallet_Deleted(Customer customer, Voucher voucher) {
        ...
        List<String> emailAddresses =
                customerVoucherWalletRepository.findOwnedCustomersByVoucher(voucher.getUuid());
    ...
    void findEmailAddressesByVoucherId_SavedVoucherId_ReturnsEmailAddresses(
        ...
        // when
        List<String> emailAddresses =
                customerVoucherWalletRepository.findOwnedCustomersByVoucher(voucherId);
