...
public class VoucherServiceTest {
    ...
    @Test
    @DisplayName("PercentDiscountVoucher 타입의 할인값 입력시 문자열을 입력하면_실패")
    void stringDiscountValueWhenPercentDiscountVoucher() {
        //given
        String voucherTypeNum = "2";
        String discountValue = "blahblah";
    ...
    @Test
    @DisplayName("PercentDiscountVoucher 타입의 할인값 입력시 음수를 입력하면_실패")
    void negativeDiscountValueWhenPercentDiscountVoucher() {
        //given
        String voucherTypeNum = "2";
        String discountValue = "-1";
    ...
    @Test
    @DisplayName("PercentDiscountVoucher 타입의 할인값 입력시 0을 입력하면_실패")
    void zeroDiscountValueWhenPercentDiscountVoucher() {
        //given
        String voucherTypeNum = "2";
        String discountValue = "0";
    ...
    @Test
    @DisplayName("PercentDiscountVoucher 타입의 할인값 입력시 100보다 큰 수를 입력하면_실패")
    void over100DiscountValueWhenPercentDiscountVoucher() {
        //given
        String voucherTypeNum = "2";
        String discountValue = "500";
    ...
    void createPercentAmountVoucher() {
        ...
        String voucherTypeNum = "2";
        String discountValue = "10";
        Voucher voucher = new PercentDiscountVoucher(UUID.randomUUID(), VoucherType.from(voucherTypeNum), discountValue);
