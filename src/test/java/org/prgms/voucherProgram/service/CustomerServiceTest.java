...
class CustomerServiceTest {
    ...
    void Should_ReturnCustomer_When_saveCustomer() {
        ...
        given(customerRepository.save(any(Customer.class))).willReturn(customerDto.toEntity());
    ...
    void Should_ThrowException_When_saveDuplicateCustomer() {
        // given
        CustomerDto customerDto = new CustomerDto(UUID.randomUUID(), "hwan", "hwan@gmail.com");
        given(customerRepository.findByEmail(anyString())).willReturn(Optional.ofNullable(customerDto.toEntity()));
        // when
    ...
    void Should_ReturnCustomerDto_When_CustomerIsExists() {
        //given
        CustomerDto customerDto = new CustomerDto(UUID.randomUUID(), "hwan", "hwan@gmail.com");
        given(customerRepository.findByEmail(any(String.class))).willReturn(Optional.of(customerDto.toEntity()));
        //when
    ...
    void Should_UpdateCustomer() {
        ...
        given(customerRepository.update(any(Customer.class))).willReturn(customerDto.toEntity());
