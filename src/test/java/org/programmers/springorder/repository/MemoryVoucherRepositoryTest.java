...
class MemoryVoucherRepositoryTest {
    ...
    void saveVoucher() {
        ...
        Voucher voucher1 = Voucher.toNewVoucher(voucherId1, 1000, VoucherType.FIXED);
        UUID voucherId2 = UUID.randomUUID();
        Voucher voucher2 = Voucher.toNewVoucher(voucherId2, 10, VoucherType.PERCENT);
    ...
    void viewAllVouchers() {
        // given
        Voucher voucher1 = Voucher.toNewVoucher(UUID.randomUUID(), 1000, VoucherType.FIXED);
        Voucher voucher2 = Voucher.toNewVoucher(UUID.randomUUID(), 10, VoucherType.PERCENT);
