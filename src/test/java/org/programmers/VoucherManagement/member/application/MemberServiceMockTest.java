...
public class MemberServiceMockTest {
    ...
    void getAllBlackMembers_EqualsListOfMembers() {
        //given
        Member member1 = new Member(UlidCreator.getUlid().toString(), "Kim", MemberStatus.BLACK);
        Member member2 = new Member(UlidCreator.getUlid().toString(), "Park", MemberStatus.BLACK);
        Member member3 = new Member(UlidCreator.getUlid().toString(), "Lee", MemberStatus.WHITE);
