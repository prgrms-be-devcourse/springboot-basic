...
class PercentDiscountVoucherTest {
    ...
    public void PercentDiscount(){
        //given
        PercentDiscountVoucher percentDiscountVoucher = new PercentDiscountVoucher(UUID.randomUUID(), 20, MenuType.PERCENT);
        //when
    ...
    void minusDiscountPrice(){
        PercentDiscountVoucher percentDiscountVoucher = new PercentDiscountVoucher(UUID.randomUUID(), 200, MenuType.PERCENT);
