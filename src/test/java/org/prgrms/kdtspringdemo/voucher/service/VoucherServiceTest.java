...
class VoucherServiceTest {
    ...
    void createFixedAmountVoucher() {
        var fixVoucher = voucherService.saveVoucher(new FixedAmountVoucher(UUID.randomUUID(), 10L));
        var percentVoucher = voucherService.saveVoucher(new PercentDiscountVoucher(UUID.randomUUID(), 20L));
