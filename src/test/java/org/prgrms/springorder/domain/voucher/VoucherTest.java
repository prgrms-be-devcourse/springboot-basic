...
class VoucherTest {
	...
	void test1() {
		Assertions.assertDoesNotThrow(() -> new FixedAmountVoucher(UUID.randomUUID(), 50,LocalDateTime.now()));
	}
	...
	void test3() {
		Assertions.assertDoesNotThrow(() -> new PercentDiscountVoucher(UUID.randomUUID(), 60,LocalDateTime.now()));
	}
