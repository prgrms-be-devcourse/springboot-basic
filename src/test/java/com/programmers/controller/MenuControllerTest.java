...
//
//import com.programmers.controller.CustomerController;
...
//import com.programmers.repository.customer.JdbcCustomerRepository;
...
//
//    @Mock
//    CustomerController customerController = new CustomerController(console, customerService);
//
//    @Mock
//    MenuController menuController = new MenuController(console, voucherService, blacklistService, customerController);
//
//    @BeforeEach
//    public void before() {
...
//        try {
//            //when
//            Voucher result = menuController.createVoucher();
//
//            //then
...
//        try {
//            //when
//            Voucher result = menuController.makeVoucher();
//            String output = outputStream.toString();
//
//            //then
//            assertTrue(output.contains(VOUCHER_TYPE_MESSAGE));
