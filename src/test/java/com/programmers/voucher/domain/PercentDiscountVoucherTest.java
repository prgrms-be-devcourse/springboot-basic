...
class PercentDiscountVoucherTest {
    ...
    void notAvailableVoucherDiscountTest(long itemPrice, long amount) {
        ...
        assertEquals(itemPrice - amount, percentDiscountVoucher.discount(itemPrice));
    }

    @DisplayName("유효한 퍼센트 바우처 할인 테스트")
    @ParameterizedTest
    @CsvSource(value = {"100, 90", "50, 2", "5, 3", "126346, 100", "1235123511, 143532343", "100, 99"})
    void availableVoucherDiscountTest(long itemPrice, long amount) {
