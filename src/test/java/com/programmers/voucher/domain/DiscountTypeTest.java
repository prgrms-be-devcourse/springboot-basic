...
class DiscountTypeTest {
    ...
    void canGetVoucherTypeWithUserInput(String command, DiscountType discountType) {
        assertEquals(discountType, DiscountType.of(command));
    }
    ...
    void getVoucherTypeFailTest(String command) {
        assertThatThrownBy(() -> DiscountType.of(command))
