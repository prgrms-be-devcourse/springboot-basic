...
class WalletJDBCRepositoryTest {
    ...
    void saveAllocatedVoucher() {
        ...
        walletJDBCRepository.insert(new Ownership(voucher.voucherId(), customer.getCustomerId()));
    ...
    void saveNonExistentVoucher() {
        ...
        assertThrows(RuntimeException.class, () -> walletJDBCRepository.insert(new Ownership(NON_EXISTENT_VOUCHER_ID, customer.getCustomerId())));
    }
