...
class ResponseBodyTest {
    ...
    @ParameterizedTest(name = "[{index}] Response Data Success Test")
    @MethodSource("whenResponseBodyDataThenSuccessDummy")
    @DisplayName("응답 데이터 저장 성공")
    void whenRequestBodyDataThenSuccessTest(char charData, int integerData,
        ...
        ResponseTestData request =
                ResponseTestData.of(charData, integerData,
    ...
    static Stream<Arguments> whenResponseBodyDataThenSuccessDummy() {
        return Stream.of(
    ...
    static class ResponseTestData {
        ...
        private ResponseTestData(char charData, int integerData, double doubleData, long longData, String stringData, List<Integer> integerListData, Set<Integer> integerSetData, Map<Integer, Integer> integerMapData) {
        ...
        public static ResponseTestData of(char charData, int integerData, double doubleData, long longData, String stringData, List<Integer> integerListData, Set<Integer> integerSetData, Map<Integer, Integer> integerMapData) {
            return new ResponseTestData(charData, integerData, doubleData, longData, stringData, integerListData, integerSetData, integerMapData);
        }
    }
}