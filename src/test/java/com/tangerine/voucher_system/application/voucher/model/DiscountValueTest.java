...
class DiscountValueTest {
    ...
    void DiscountValue_ParamNegative_Exception(VoucherType voucherType, double input) {
    ...
    void DiscountValue_ParamUpper100_Exception(VoucherType voucherType, double input) {
        Exception exception = catchException(() -> new DiscountValue(voucherType, input));
