...
class VoucherControllerMockTest {
    ...
    void createMapServiceTest() {
        ...
        // when
        ApplicationResponse response = voucherController.toResponse(CREATE, null);
    ...
    void listMapServiceTest() {
        ...
        // when
        ApplicationResponse response = voucherController.toResponse(LIST, null);
    ...
    void exitMapServiceTest() {
        ...
        // when
        ApplicationResponse response = voucherController.toResponse(EXIT, null);
