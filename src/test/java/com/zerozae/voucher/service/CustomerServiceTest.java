...
class CustomerServiceTest {
    ...
    void createCustomer_Success_Test() {
        ...
        // Then
        assertEquals(savedCustomer.getCustomerName(), customerResponse.getCustomerName());
        verify(customerRepository, times(1)).save(any(Customer.class));
    }

    @Test
    @DisplayName("회원 전체 조회 메서드 테스트")
    ...
    void validateDuplicateCustomer_Success_Test() {
        // Given
