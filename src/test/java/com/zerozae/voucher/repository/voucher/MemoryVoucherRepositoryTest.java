...
class MemoryVoucherRepositoryTest {
    ...
    void findVouchersByCustomerId_Success_Test() {
        ...
        voucherRepository.registerVoucher(customerId, fixedDiscountVoucher.getVoucherId());

        // When
        List<Voucher> vouchers = voucherRepository.findVouchersByCustomerId(customerId);

        // Then
        assertThat(vouchers, contains(fixedDiscountVoucher));
    }
    ...
    void removeVoucherFromCustomer_Success_Test() {
        ...
        // When
        voucherRepository.removeVoucher(fixedDiscountVoucher.getVoucherId());

        // Then
        List<Voucher> vouchers = voucherRepository.findVouchersByCustomerId(customerId);
        assertThat(vouchers, not(contains(fixedDiscountVoucher)));
    }
