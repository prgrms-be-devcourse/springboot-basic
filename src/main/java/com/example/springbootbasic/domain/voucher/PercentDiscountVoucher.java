...
public class PercentDiscountVoucher extends Voucher {
    ...
    public PercentDiscountVoucher(Long discountValue,
        ...
        super(discountValue, PERCENT_DISCOUNT, createdAt, startAt, endAt);
        validateDiscountValue(discountValue);
    }

    public PercentDiscountVoucher(Long voucherId,
                                  Long discountValue,
                                  LocalDateTime createdAt,
                                  LocalDateTime startAt,
                                  LocalDateTime endAt
    ) {
        super(voucherId, discountValue, PERCENT_DISCOUNT, createdAt, startAt, endAt);
        validateDiscountValue(discountValue);
    }
