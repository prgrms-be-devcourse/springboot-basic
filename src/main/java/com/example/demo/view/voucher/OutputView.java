...
public class OutputView {
    ...
    public static final String VOUCHER_AMOUNT_UPDATE_MESSAGE = "    바우처 할인 금액을 입력해주세요 >> : ";
    ...
    public void printVoucherAmountInfoMessageWithOutTypeInfo() {
        System.out.print(VOUCHER_AMOUNT_UPDATE_MESSAGE);
    }
