...
public class PercentDiscountVoucher extends Voucher {
    ...
    private static final int PERCENT_MINIMUM_DISCOUNT_AMOUNT = 1;
    private static final int PERCENT_MAXIMUM_DISCOUNT_AMOUNT = 100;
    private static final String PERCENT_DISCOUNT_AMOUNT_VALIDATION_EXCEPTION_MESSAGE = "백분율할인 바우처는" + PERCENT_MINIMUM_DISCOUNT_AMOUNT + "이상" + PERCENT_MAXIMUM_DISCOUNT_AMOUNT + "이하만 가능합니다.";
