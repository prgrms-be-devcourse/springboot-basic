...
public enum QueryMessage {
    ...
    FIND_BY_ID_QUERY_CUSTOMER("select * from customers where customer_id = UUID_TO_BIN(?)"),
    ...
    FIND_BY_ID_QUERY_VOUCHER("select * from vouchers where voucher_id = UUID_TO_BIN(?)"),
