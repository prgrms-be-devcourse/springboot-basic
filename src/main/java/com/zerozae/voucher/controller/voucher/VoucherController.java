...
public class VoucherController {
    ...
    public Response registerVoucher(UUID customerId, UUID voucherId) {
        try {
    ...
    public Response findHaveVouchers(UUID customerId) {
        try {
    ...
    public Response removeVoucher(UUID voucherId) {
        try {
    ...
    public Response findVoucherOwnerId(UUID voucherId) {
        try {
