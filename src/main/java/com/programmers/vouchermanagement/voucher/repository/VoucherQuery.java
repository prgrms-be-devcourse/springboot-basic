...
public class VoucherQuery {
    ...
    public static final String FIND_ALL_BY_CREATED_AT = "SELECT * FROM test.vouchers WHERE created_at BETWEEN DATE(:from) AND DATE(:to)";
    public static final String FIND_ALL_BY_TYPE = "SELECT * FROM test.vouchers WHERE type = :type";
