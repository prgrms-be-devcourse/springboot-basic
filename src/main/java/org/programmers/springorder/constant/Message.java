...
public class Message {
    ...
    public static final String INPUT_VOUCHER_ID = "Q. 바우처 ID를 입력해주세요.";
    ...
    public static final String WALLET_MENU_SELECT_MESSAGE = """
                        
            === Wallet Menu ===
            1. Assign a voucher to customer.
            2. Check vouchers with customer.
            3. Remove the voucher by customer.
            4. Check the customer with vouchers.
            5. Back to menu.
            """;
    public static final String INPUT_CUSTOMER_ID_MESSAGE = "Q. 고객 ID를 입력해주세요.";
    public static final String VOUCHER_ASSIGNED = "고객에게 바우처를 할당했습니다.";
