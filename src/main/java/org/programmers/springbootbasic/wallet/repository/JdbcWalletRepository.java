...
public class JdbcWalletRepository implements WalletRepository {
    ...
    public Wallet insert(Wallet wallet) {
        ...
        int insert = jdbcTemplate.update("INSERT INTO wallets(wallet_id, customer_id, voucher_id) " +
                "VALUES (UUID_TO_BIN(:walletId), UUID_TO_BIN(:customerId), UUID_TO_BIN(:voucherId))", params);
        if (insert != SUCCESS) {
