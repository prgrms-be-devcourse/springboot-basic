...
public class RestVoucherController {
    ...
    public VoucherResponse findVoucher(@PathVariable("voucherId") UUID voucherId) {
    ...
    public VoucherResponse updateVoucher(@RequestBody UpdateVoucherRequest updateVoucherRequest) {
