...
public class WalletController {
    ...
    public void addWallet() {
        ...
        try {
            ...
            WalletRequestDto requestDto = WalletEntityMapper.INSTANCE.mapToDto(email, voucherId);
    ...
    public void findVoucherListByEmail() {
        ...
        try {
            email = consoleIOManager.getInput();
            WalletRequestDto requestDto = WalletEntityMapper.INSTANCE.mapToDtoWithEmail(email);
    ...
    public void findCustomerListByVoucherId() {
        ...
        try {
            ...
            WalletRequestDto requestDto = WalletEntityMapper.INSTANCE.mapToDtoWithUUID(input);
