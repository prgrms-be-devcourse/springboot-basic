...
public abstract class Voucher implements Serializable {
    ...
    protected Voucher(UUID voucherId, LocalDateTime createdDateTime) {
        this(voucherId, null, createdDateTime);
    }

    protected Voucher(UUID voucherId, UUID customerId, LocalDateTime createdDateTime) {
