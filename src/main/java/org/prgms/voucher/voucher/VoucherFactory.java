...
public class VoucherFactory {
    ...
    private final static long MIN_PERCENTAGE = 0L;
    private final static long MAX_PERCENTAGE = 100L;
    private final static long MIN_FIXED_AMOUNT = 0;


    public static Voucher createVoucher(VoucherPolicy voucherPolicy, long amount) {
    ...
    private static void validatePercentage(long amount) {
