...
public enum VoucherType {
    FIXED_AMOUNT(1) {
        @Override
        public Voucher newVoucher(UUID voucherId, int discountAmount, LocalDateTime createdAt) {
    ...
    public abstract Voucher newVoucher(UUID voucherId, int discountAmount, LocalDateTime createdAt);
