...
import org.prgrms.orderApp.commandOperator.script.WarnningAndErrorScript;
import org.prgrms.orderApp.commandOperator.util.CheckInvalid;
import org.prgrms.orderApp.commandOperator.util.MainMenu;
...
public class MainPage {
    ...
    public String selectedMainMenu(){
        ...
        return MainMenu.getMenuNameByMenuNumber(Integer.parseInt(userSelected));
    }
