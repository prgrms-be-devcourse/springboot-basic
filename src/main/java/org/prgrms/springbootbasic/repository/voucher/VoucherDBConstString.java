...
public class VoucherDBConstString {
    ...
    public static final String DELETE_BY_VOUCHER_ID_SQL = "delete from vouchers where voucher_id = uuid_to_bin(?)";

    public static final String UPDATE_CUSTOMER_ID_SQL = "update vouchers set customer_id = uuid_to_bin(?) where voucher_id = uuid_to_bin(?)";
