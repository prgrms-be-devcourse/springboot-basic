...
public enum MessageGuide {
    COMMAND_OPTION(
            ...
            "Type " + MessageGuide.ANSI_BOLD + "customers" + MessageGuide.ANSI_RESET + " to " + MessageGuide.ANSI_BOLD + "list" + MessageGuide.ANSI_RESET + " all customers.\n" +
            "Type " + MessageGuide.ANSI_BOLD + "blacklist" + MessageGuide.ANSI_RESET + " to " + MessageGuide.ANSI_BOLD + "list" + MessageGuide.ANSI_RESET + " all blocked customers."
    ),
    VOUCHER_TYPE(
            "=== Select Voucher Type ===\n" +
