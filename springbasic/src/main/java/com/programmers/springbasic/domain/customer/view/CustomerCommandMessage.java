...
public enum CustomerCommandMessage {
    ...
    CUSTOMER_UPDATE_ID_MESSAGE("갱신하고자 하는 고객의 id를 입력해주세요."),
    CUSTOMER_UPDATE_NAME_MESSAGE("새로운 이름을 입력해주세요."),
    CUSTOMER_UPDATE_EMAIL_MESSAGE("새로운 이메일을 입력해주세요."),
    CUSTOMER_UPDATE_FINISHED_MESSAGE("Customer Successfully Updated!"),
